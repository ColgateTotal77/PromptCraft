        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className={ cn(DS.card.base, 'flex flex-col gap-2 bg-gray-100 p-4') }>
            <div className="flex items-center gap-2">
              ...
              <h4 className={ cn(DS.text.label, 'text-gray-900') }>Variables Found</h4>
            </div>

            { templateData.variables.length > 0 ? (
              <ul className={ cn(DS.text.metaMuted, 'text-gray-600 space-y-2 list-none pl-1') }>
              ...
              <p className={ cn(DS.text.metaMuted, 'italic pl-1') }>No variables detected</p>
            ) }
          </div>
        </div>

        <div className="lg:col-span-3">
          <div className={ cn(DS.card.base, 'flex flex-col overflow-hidden h-full w-full min-h-[300px]') }>
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-gray-50/30">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  className={ cn(DS.button.base, DS.button.ghost, DS.button.icon, isEditing && 'bg-gray-100 text-gray-900') }
                  title="Edit"
                  onClick={ onEdit }
                >
            ...
            <textarea
              ...
              className={ cn(DS.input.base, DS.input.textarea, 'h-full p-6 font-mono text-sm leading-relaxed') }
              spellCheck={ false }
            />
          </div>
        </div>
